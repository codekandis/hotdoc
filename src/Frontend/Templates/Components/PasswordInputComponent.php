...
/**
 * Represents a password input form control.
 * @package codekandis/hotdoc
 * @author Christian Ramelow <info@codekandis.net>
 */
class PasswordInputComponent extends AbstractFormControlComponent
{
	/**
	 * Stores the name of the password input.
	 * @var ?string
	 */
	private ?string $name;

	/**
	 * Stores the placeholder of the password input.
	 * @var ?string
	 */
	private ?string $placeholder;

	/**
	 * Stores the value of the password input.
	 * @var ?string
	 */
	 ...
	 * @param ?string $placeholder The placeholder of the password input.
	...
	/**
	 * Renders the placeholder of the password input.
	 * @return ?string The placeholder of the password input, if set, otherwise null.
	 */
	...
	/**
	 * Renders the value of the password input.
	 * @return ?string The value of the password input, if set, otherwise null.
	 */
		...
		return sprintf(
			<<<END
				<%1\$s data-component-type="%2\$s" data-component-style="%3\$s">
					<input%4\$s%5\$s%6\$s%7\$s%8\$s%9\$s type="password"/>
				</%1\$s>
			END,
			$this->htmlTag,
			ComponentTypes::PASSWORD_INPUT,
			$this->style,
			$this->renderId(),
			$this->renderClasses(),
